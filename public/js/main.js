import { App, subscribe, setScreen, setRoomState, clearSession, startPolling } from './state.js?v=12.0';
import { fetchState } from './api.js?v=12.0';
import { captureRects, playFlip } from './flip.js?v=12.0';
import { renderHome, mountHome } from './screens/home.js?v=12.0';
import { renderCreate, mountCreate } from './screens/create.js?v=12.0';
import { renderJoin, mountJoin } from './screens/join.js?v=12.0';
import { renderRoom, mountRoom } from './screens/room.js?v=12.0';
...
import { clearDelegatedListeners } from './dom.js?v=12.0';
...
async function boot() {
  if (App.session) {
    try {
      ...
      setRoomState(state);
      setScreen('room', { entryActive: true, entryStartedAt: Date.now() });
      startPolling();
      return;
    } catch {
      clearSession();
