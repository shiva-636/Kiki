import { App, setLoading, setError, showToast } from '../state.js?v=12.0';
import { sendAction } from '../api.js?v=12.0';
import { on, escapeHtml, avatarColor } from '../dom.js?v=12.0';
import { prefersReducedMotion } from '../dom.js?v=12.0';
import { renderChat } from './chat.js?v=12.0';
import { renderScoreboard } from './scoreboard.js?v=12.0';
