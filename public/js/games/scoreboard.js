import { App } from '../state.js?v=12.0';
import { escapeHtml, avatarColor, initials } from '../dom.js?v=12.0';
...
export function renderScoreboard(room) {
  ...
  return `
    <section class="scoreboard-section ${App.ui.scoreOpen ? 'is-open' : ''}" aria-label="KIKI scoreboard">
