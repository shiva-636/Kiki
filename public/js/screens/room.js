...
import { renderWheelGame, mountWheelGame } from '../games/wheelGame.js?v=7.1';
import { renderThreeSet, mountThreeSet } from '../games/threeSet.js?v=7.0';
import { renderChat, mountChat } from '../games/chat.js?v=7.0';
import { mountVoiceChat, shutdownVoiceChat } from '../voiceChat.js?v=7.0';
  ...
  return `
    <div class="screen screen-room">
      <header class="room-topbar">
        ...
        <button class="btn-icon voice-toggle" data-voice-toggle type="button" aria-label="Turn voice chat on" aria-pressed="false" title="Turn voice chat on">🎙️</button>
...
export function mountRoom(root) {
  ...
  mountVoiceChat(root, { room, session });
}
